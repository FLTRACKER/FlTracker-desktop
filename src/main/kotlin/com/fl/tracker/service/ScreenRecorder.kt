...
class ScreenRecorder {
    ...
    private val timeOutScreen: Long = TimeUnit.SECONDS.toMillis(20) // sec
    ...
    var idSession = mutableStateOf<Long>(0)
    ...
    private fun checkProcess() {
        if (Platform.isWindows()) {
            try {
                ...
                User32.INSTANCE.GetWindowText(userWin, buffer, 1024)
